...
// source file: cg/point_cloud_sprite_fp.cg
...
void main()
{
    ...
    _x0011 = (gl_TexCoord[0].y - 1.99999996E-02)/3.00000012E-02;
    _b0017 = min(1.00000000E+00, _x0011);
    _TMP12 = max(0.00000000E+00, _b0017);
    _x0019 = (gl_TexCoord[0].y - 9.49999988E-01)/3.00000310E-02;
    _b0025 = min(1.00000000E+00, _x0019);
    _TMP20 = max(0.00000000E+00, _b0025);
    _x0027 = (gl_TexCoord[0].x - 1.99999996E-02)/3.00000012E-02;
    _b0033 = min(1.00000000E+00, _x0027);
    _TMP28 = max(0.00000000E+00, _b0033);
    _x0035 = (gl_TexCoord[0].x - 9.49999988E-01)/3.00000310E-02;
